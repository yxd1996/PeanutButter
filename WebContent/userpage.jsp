	...
	<!-- ——————————————————个人信息部分 ——————————————————-->
		...
		<div class="col-md-2 column">
			...
			<div class = "name-box">
					...
					<img alt="" src="images/userpage/female.png" class = "gender-symbol" />
			</div>

			<div class = "statistic-box">
				<ul class = "statistic-item"  style = "border-left-style:none">
					<li class = "statistic-data">
						35
					</li>
					<li class = "statistic-name">
						关注
					</li>
				</ul>
			...
			<div class = "option-list">
				<button class = "btn option-item">
					关注TA
				</button>
				<button id = "post" class = "btn option-item">
					我发布的
				</button>
				<button id = "favorite" class = "btn option-item">
					我收藏的
				</button>
			</div>
			</div>
...
<!-- ——————————————————我发布的—————————————————— -->
		<div class="col-md-9 column text-top">
					<div class = "myworks-titleline">
						<h1 id = "post-header" class = "myworks-title">
							我发布的
						</h1>
					</div>
...
<!-- ——————————————————我收藏的—————————————————— -->
					...
					<div class = "myworks-titleline">
						<h2 id = "favorite-header" class = "myworks-title">
							我收藏的
						</h2>
					</div>
