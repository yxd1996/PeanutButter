			...
			<div class="col-md-9 column text-top">
				<div class="row clearfix">
					<div class="col-md-10 column">
						...
						<span class="label label-default tip">#中式</span> <span
							class="label label-default tip">#简易</span> <span
							class="label label-default tip">#点心</span>
					</div>
					<div class="col-md-2 column">
						<button type="button"
				...
				<img alt="" src="images/201704090001/201704090001_0.jpeg"
					class="main_pic" />
				...
				<div class="row clearfix buzhou_padding">
					...
					<div class="col-md-11 column">
						<p>准备食材并称重，核桃是买的炒熟的。</p>
						<img alt="" src="images/201704090001/201704090001_1.jpeg"
							class="buzhou_pic" />
					</div>
				</div>
				<div class="row clearfix buzhou_padding">
					...
					<div class="col-md-11 column">
						<p>核桃仁用手掰碎，或放在保鲜袋里用擀面杖压碎，不用压得过份碎，颗粒大些吃起来更爽。</p>
						<img alt="" src="images/201704090001/201704090001_2.jpeg"
							class="buzhou_pic" />
					</div>
				</div>
				<div class="row clearfix buzhou_padding">
					...
					<div class="col-md-11 column">
						<p>把50克玉米油倒在打蛋盆里，放入1克盐与30克糖粉，用打蛋器搅打均匀。</p>
						<img alt="" src="images/201704090001/201704090001_3.jpeg"
							class="buzhou_pic" />
					</div>
				</div>
				<div class="row clearfix buzhou_padding">
					...
					<div class="col-md-11 column">
						<p>加入鸡蛋液继续搅打均匀。</p>
						<img alt="" src="images/201704090001/201704090001_4.jpeg"
							class="buzhou_pic" />
					</div>
				</div>
				<div class="row clearfix buzhou_padding">
					...
					<div class="col-md-11 column">
						<p>放入过筛后的110克低筋面粉与1克泡打粉和1克苏打粉。</p>
						<img alt="" src="images/201704090001/201704090001_5.jpeg"
							class="buzhou_pic" />
					</div>
				</div>
				<div class="row clearfix buzhou_padding">
					...
					<div class="col-md-11 column">
						<p>用硅胶刮刀拌匀。</p>
						<img alt="" src="images/201704090001/201704090001_6.jpeg"
							class="buzhou_pic" />
					</div>
				</div>
				<div class="row clearfix buzhou_padding">
					...
					<div class="col-md-11 column">
						<p>将核桃仁与面糊翻拌均匀。</p>
						<img alt="" src="images/201704090001/201704090001_7.jpeg"
							class="buzhou_pic" />
					</div>
				</div>
				<div class="row clearfix buzhou_padding">
					...
					<div class="col-md-11 column">
						<p>这是拌好的面糊。</p>
						<img alt="" src="images/201704090001/201704090001_8.jpeg"
							class="buzhou_pic" />
					</div>
				</div>
				<div class="row clearfix buzhou_padding">
					...
					<div class="col-md-11 column">
						<p>把核桃酥先称重二十克一个搓成圆球，排列在不粘烤盘里。</p>
						<img alt="" src="images/201704090001/201704090001_9.jpeg"
							class="buzhou_pic" />
					</div>
				</div>
				<div class="row clearfix buzhou_padding">
					...
					<div class="col-md-11 column">
						<p>用手掌逐一把饼按扁。</p>
						<img alt="" src="images/201704090001/201704090001_10.jpeg"
							class="buzhou_pic" />
					</div>
				</div>
				<div class="row clearfix buzhou_padding">
					...
					<div class="col-md-11 column">
						<p>刷上一层蛋液，中间撒上黑芝麻。</p>
						<img alt="" src="images/201704090001/201704090001_11.jpeg"
							class="buzhou_pic" />
					</div>
				</div>
				<div class="row clearfix buzhou_padding">
					...
					<div class="col-md-11 column">
						<p>放入预热好的烤箱，中层175度烤20分钟。</p>
						<img alt="" src="images/201704090001/201704090001_12.jpeg"
							class="buzhou_pic" />
					</div>
				</div>
				<div class="row clearfix buzhou_padding">
					...
					<div class="col-md-11 column">
						<p>时间差不多时，出炉，核桃酥色泽金黄鲜艳，大小外形完整，面呈裂纹，入口很香很酥！</p>
						<img alt="" src="images/201704090001/201704090001_13.jpeg"
							class="buzhou_pic" />
					</div>
				</div>
				<div class="row clearfix buzhou_padding">
					...
					<div class="col-md-11 column">
						<p>冷却之后更是酥香。</p>
						<img alt="" src="images/201704090001/201704090001_14.jpeg"
							class="buzhou_pic" />
					</div>
				</div>
				<div class="row clearfix buzhou_padding">
					...
					<div class="col-md-11 column">
						<p>质地细腻，柔软，口味滋糯，纯甜，有突出的桃仁清香。</p>
						<img alt="" src="images/201704090001/201704090001_15.jpeg"
							class="buzhou_pic" />
					</div>
				</div>
				<div class="row clearfix buzhou_padding">
					...
					<div class="col-md-11 column">
						<p>彻底放凉后，放入密封盒保存。</p>
						<img alt="" src="images/201704090001/201704090001_16.jpeg"
							class="buzhou_pic" />
					</div>
				</div>

				<button type="button"
					class="btn btn-warning btn-lg btn-block buzhou_padding startnow_btn">很简单？现在就去动手做吧~</button>
